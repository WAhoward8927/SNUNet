...
mask_dir=Path('/content/drive/MyDrive/SNUNet/SYSU/reports/Vis/masks')
mask_dir.mkdir(parents=True,exist_ok=True)
for batch_index,(batch_img1,batch_img2,labels) in enumerate(tbar):
        ...
        for item_index,prediction in enumerate(cd_preds.detach().cpu().numpy()):
            Image.fromarray((prediction.astype('uint8')*255), mode='L').save(mask_dir/f'test_{batch_index:04d}_{item_index:02d}.png')
